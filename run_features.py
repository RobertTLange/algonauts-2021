...
def generate_and_compress(model_type: str, filter_config: dict,
    ...
    save_dir = f'data/features/{model_type}/{filter_config["filter_type"]}'
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sampling_rate', '--sampling_rate',
                        default=4, type=int, help='Video Sampling Rate.')
    ...
    filter_config = {"filter_name": "mean",
                     ...
                     "filter_type": "mean_sr_" + str(cmd_args.sampling_rate)}
