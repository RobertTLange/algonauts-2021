...
#     --base_train_config configs/train/roi/pls_250_resnet50.json \
#     --experiment_dir experiments/roi/pls_250_resnet50_bo_25/
# mle run configs/cluster/base_roi.yaml \
#     --no_welcome \
#     --purpose PLS PCA 500 ResNet50 ROI BO 25 \
...
mle run configs/cluster/base_roi.yaml \
    ...
    --experiment_dir experiments/roi/pls_umap2_100_resnet50_bo_25/
mle run configs/cluster/base_roi.yaml \
    --no_welcome \
    --purpose PLS UMAP 250 ResNet50 ROI BO 25 \
    --base_train_config configs/train/roi/pls_umap_250_resnet50.json \
    --experiment_dir experiments/roi/pls_umap2_250_resnet50_bo_25/
mle run configs/cluster/base_roi.yaml \
    --no_welcome \
    --purpose PLS UMAP 500 ResNet50 ROI BO 25 \
    --base_train_config configs/train/roi/pls_umap_500_resnet50.json \
    --experiment_dir experiments/roi/pls_umap2_500_resnet50_bo_25/
mle run configs/cluster/base_roi.yaml \
    --no_welcome \
    --purpose PLS MDS 100 ResNet50 ROI BO 25 \
    --base_train_config configs/train/roi/pls_mds_100_resnet50.json \
    --experiment_dir experiments/roi/pls_mds_100_resnet50_bo_25/
mle run configs/cluster/base_roi.yaml \
    --no_welcome \
    --purpose PLS MDS 250 ResNet50 ROI BO 25 \
    --base_train_config configs/train/roi/pls_mds_250_resnet50.json \
    --experiment_dir experiments/roi/pls_mds_250_resnet50_bo_25/
mle run configs/cluster/base_roi.yaml \
    --no_welcome \
    --purpose PLS MDS 500 ResNet50 ROI BO 25 \
    --base_train_config configs/train/roi/pls_autoencoder_500_resnet50.json \
    --experiment_dir experiments/roi/pls_autoencoder_500_resnet50_bo_25/
mle run configs/cluster/base_roi.yaml \
    --no_welcome \
    --purpose PLS Autoencoder 100 ResNet50 ROI BO 25 \
    --base_train_config configs/train/roi/pls_autoencoder_100_resnet50.json \
    --experiment_dir experiments/roi/pls_autoencoder_100_resnet50_bo_25/
mle run configs/cluster/base_roi.yaml \
    --no_welcome \
    --purpose PLS Autoencoder 250 ResNet50 ROI BO 25 \
    --base_train_config configs/train/roi/pls_autoencoder_250_resnet50.json \
    --experiment_dir experiments/roi/pls_autoencoder_250_resnet50_bo_25/
mle run configs/cluster/base_roi.yaml \
    --no_welcome \
    --purpose PLS Autoencoder 500 ResNet50 ROI BO 25 \
    --base_train_config configs/train/roi/pls_autoencoder_500_resnet50.json \
    --experiment_dir experiments/roi/pls_autoencoder_500_resnet50_bo_25/
