...
def get_train_test_split_ids(num_data_points: int,
                             test_set_size: float) -> np.ndarray:
...
def get_train_test_split_loaders(X: np.ndarray,
                                 y: np.ndarray,
    ...
    train_loader, test_loader = wrap_data_torch(X, y, train_ids, test_ids,
                                                batch_size)
    return train_loader, test_loader


def wrap_data_torch(X: np.ndarray,
                    y: np.ndarray,
